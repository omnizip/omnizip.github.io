    ...
    <section class="section-padding">
      <div class="container-wide">
        <div class="text-center mb-12">
          ...
          <p class="text-light-muted dark:text-dark-muted max-w-2xl mx-auto">
            All published to crates.io at v0.16.85, dual licensed MIT OR Apache-2.0.
...
const stats = [
  ...
  { value: 'v0.16.85', label: 'live on crates.io' },
...
const benchHighlights = [
  ...
  { codec: 'lz4hc', level: '3', output: '43.0 MB', ratio: '43.0%', encode: '5.2 MiB/s', decode: '117 MiB/s' },
  { codec: 'zstd', level: '3', output: '46.5 MB', ratio: '46.5%', encode: '15.1 MiB/s', decode: '57.3 MiB/s' },
  { codec: 'lz4', level: '12', output: '53.0 MB', ratio: '53.0%', encode: '73.1 MiB/s', decode: '145 MiB/s' },
]
